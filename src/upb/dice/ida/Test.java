...
public class Test {
	...
	public static void main(String[] args) {
		...
		FDG_Triple triple1 = new FDG_Triple(1, node1, node2, 1);
		FDG_Triple triple2 = new FDG_Triple(2, node1, node3, 2);
		FDG_Triple triple3 = new FDG_Triple(3, node2, node4, 2);
		FDG_Triple triple4 = new FDG_Triple(4, node3, node4, 5);
